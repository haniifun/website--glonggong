                    ...
                    <div class="modal-content">
                      ...
                      <form method="post" action="<?= base_url('admin/tambahKategori') ?>" >
                        <div class="modal-body">
                            <input type="hidden" name="tabel" value="kategori">
                    ...
                    <div class="modal fade" id="<?= 'hapus'.$row['id']?>">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <p>Anda yakin ingin menghapus <b><?= $row['kategori'] ?></b>?</p>
                          </div>
                    ...
                    <div class="modal fade" id="<?= 'edit'.$row['id'] ?>">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form method="post" action="<?= base_url('admin/editKategori/'.$row['id']) ?>" enctype="multipart/form-data">
                            <div class="modal-body">
                                <input type="hidden" name="tabel" value="kategori">
                                <input type="hidden" name="page" value="kategori">
                                <div class="form-group">
                                  <label for="kategori">Kategori</label>
                                  <input type="text" class="form-control" id="kategori" name="kategori" placeholder="kategori lengkap" value="<?= $row['kategori'] ?>">
                                </div>
                            </div>
                            <div class="modal-footer justify-content-between">
                              <button type="button" class="btn btn-danger" data-dismiss="modal">Batal</button>

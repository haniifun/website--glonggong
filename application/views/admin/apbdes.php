                ...
                <div class="modal fade" id="modal-tambah">
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                      ...
                      <form method="post" action="<?= base_url('admin/tambahApbdes') ?>" enctype="multipart/form-data">
                        <div class="modal-body">
                            <div class="form-group">
                              <label for="deskripsi">Deskripsi</label>
                              <input type="text" class="form-control" id="deskripsi" name="deskripsi" placeholder="Deskripsi nama file">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                              <label for="file">File APBDes</label>
                        ...
                        <div class="modal-content">
                          ...
                          <form method="post" action="<?= base_url('admin/hapusAnggota') ?>" >
                            <div class="modal-footer justify-content-between">
                                ...
                                <input type="hidden" name="page" value="apbdes">
                                <input type="hidden" name="tabel" value="apbdes">
                    ...
                    <div class="modal fade" id="<?= 'edit'.$row['id'] ?>">
                      <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                          ...
                          <form method="post" action="<?= base_url('admin/editApbdes/'.$row['id']) ?>" enctype="multipart/form-data">
                            <div class="modal-body">
                                <div class="form-group">
                                  <label for="deskripsi">Deskripsi</label>
                                ...
                                <div class="form-group">
                                  <label for="tahun">Tahun</label>
                                  <input type="number" class="form-control" id="tahun" name="tahun" placeholder="Nama lengkap" value="<?= $row['tahun'] ?>">
                                </div>
                                <div class="form-group">

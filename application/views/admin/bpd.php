                    ...
                    <div class="modal-content">
                      ...
                      <form method="post" action="<?= base_url('admin/tambahAnggota') ?>" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input type="hidden" name="tabel" value="bpd">
                            <input type="hidden" name="page" value="bpd">
                            <div class="form-group">
                              <label for="nama">Nama</label>
                              <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama lengkap" autofocus="true">
                            </div>
                            <div class="form-group">
                        ...
                        <div class="modal-content">
                          ...
                          <form method="post" action="<?= base_url('admin/editAnggota/'.$row['id']) ?>" enctype="multipart/form-data">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                  <label for="nama">Nama</label>
                                  <input type="text" class="form-control" id="nama" name="nama" placeholder="Nama lengkap" autofocus value="<?= $row['nama'] ?>">
                                </div>
                                <div class="form-group">
                                  <label for="jabatan">Jabatan</label>
